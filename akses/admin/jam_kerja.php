          ...
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-header">
                <h5 class="title">Jam kerja ke <?php echo $i++; ?></h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input name="hari" type="text" class="form-control" placeholder="Masukan Hari" value="<?=$cs1['hari'];?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input name="jam" type="text" class="form-control" placeholder="Masukan Jam" value="<?=$cs1['jam'];?>">
                      </div>
                    </div>
                  </div>
