                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="ubah_data.php?id=<?=$barang['id_barang']; ?>">ubah</a>||<a href="hapus_data.php?id=<?=$barang['id_barang']; ?>">hapus</a>
                        </td>
                        <td>
                          <?= $barang["kode_barang"] ?>
                        </td>
                        ...
                        <td >
                          <img width="150" src="gambar/<?=$barang["gambar_barang"] ?>">
                        </td>
                        <td>
                          <?= $barang["stok_barang"] ?>
                        </td>
