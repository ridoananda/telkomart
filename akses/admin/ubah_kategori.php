...
<form action="" method="post" enctype="multipart/form-data">
  <div class="container">
    ...
    <input type="hidden" name="gambarLama" value="<?=$kategori['gambar_kategori']?>">
    <label for="Nama"><b>Nama Kategori :</b></label>
    <input type="text" placeholder="Masukkan Judul banner" name="nama" value="<?=$kategori['nama_kategori']?>" >

    <label for="gambar"><b>Masukkan Gambar Kategori :</b></label><br><br>
    <img width="100" src="../../file/img/<?=$kategori['gambar_kategori']; ?>">
    <br><br>
