    ...
    <div class="main-panel" id="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Navbar Input</a>
          </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <?php foreach($about as $about1): ?>
              <div class="card-header">
                <h5 class="title">About Us
              </div>
              <div class="card-body">
                <form action="" method="POST">
                 <input type="hidden" name="id"  value="<?=$about1["id"];?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>About Me</label>
                        <textarea rows="4" cols="80" class="form-control" name="about"><?= $about1["about_me"]; ?>
                        </textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="ketik disini" name="tanya">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Here can be your description FAQ" name="syarat"></textarea>
                      </div>
                    </div>
                  </div>
                  <input style="background-color:#e32a00; color: black; font-weight: bold; font-size: 15px; " type="submit" class="form-control" placeholder="Home Address" name="submit1" value="TAMBAH FAQ">
