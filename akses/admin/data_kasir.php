<?php 
require 'fungsi.php';
$data_kasir = query("SELECT * FROM kasir");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Data Kasir</a>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <?php $i = 1; 
                      foreach ($data_kasir as $karyawan) : ?>
                      <tr>
                        <td>
                          <?= $i++; ?>
                        </td>
                        <td>
                          <a href="ubah_karyawan.php?id=<?=$karyawan['id']; ?>">ubah</a>||<a href="hapus_karyawan.php?id=<?=$karyawan['id']; ?>">hapus</a>
                        </td>
                        <td>
