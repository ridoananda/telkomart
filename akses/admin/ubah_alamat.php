<?php 
  ...
  $data = query("select * from alamat where id=$idd")[0];
...
<form action="" method="post" enctype="multipart/form-data">
  <div class="container">
    <div class="atas">
    <h1>UPDATE DATA ALAMAT</h1>
    </div>
    <hr >
    <input type="hidden" name="id" value="<?= $data['id']; ?>">
    <label for="Nama"><b>Masukan alamat Lengkap</b></label>
    <input type="text" placeholder="Masukkan Judul banner" name="nama" value="<?= $data['nama_alamat']; ?>" >

    <label for="Nama"><b>Daerah : </b></label>
    <input type="text" placeholder="Masukkan daerah" name="daerah" value="<?= $data['nama_daerah']; ?>"  >
